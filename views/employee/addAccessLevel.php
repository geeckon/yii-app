...
/** @var app\models\AddAccessLevelToEmployeeForm $model */
...
<div class="employees-add">
    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            <?= $form->field($model, 'employee_id')->hiddenInput(['value' => $model->employee_id])->label(false) ?>
